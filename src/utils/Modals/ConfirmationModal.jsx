...
const ConfirmationModal = ({
  ...
  const Icon = icon === "danger" ? LogOut : Laptop;
  const iconColor = icon === "danger" ? "text-red-500" : "text-blue-500";
  ...
  return (
    ...
    >
      <div
        ...
        } rounded-md shadow-xl max-w-md w-full relative transform transition-all duration-300 ${
        ...
        <div className={`border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}>
          <div className="p-6 pb-2 flex items-center mb-4">
            ...
            <h2 className="text-2xl font-bold">
              {title}
              {icon === "success" && <span className="text-blue-500">Confirmation</span>}
            </h2>
          </div>
        </div>
