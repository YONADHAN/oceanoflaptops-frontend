        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
            <motion.div 
              ...
              className="p-6 bg-gradient-to-br from-blue-100 to-blue-500 rounded-lg hover:shadow-lg transition-shadow"
            >
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.7 }}
              className="relative h-96 bg-gray-800 rounded-xl overflow-hidden"
            >
              <img
